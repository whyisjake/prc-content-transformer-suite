...
Open with a single spoken attribution line naming the piece and its source, then a brief pause marker (a paragraph break). Do not invent a title — use the one supplied.
